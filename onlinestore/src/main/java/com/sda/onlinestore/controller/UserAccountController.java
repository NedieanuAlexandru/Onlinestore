...
public class UserAccountController {
    ...
    public ResponseEntity<UserAccountDto> getUserUsername(@PathVariable("username") String username) {
        UserAccountDto userAccountDto = userAccountService.getUsername(username);
        return new ResponseEntity(userAccountDto, HttpStatus.OK);
    }
