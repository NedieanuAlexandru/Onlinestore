...
export class UserAccountService {
  ...
  public getUserAccountString(username: String): Observable<UserAccountData> {
    return this.httpClient.get<UserAccountData>('https://localhost:8080/getUsername/' + username);
  }
